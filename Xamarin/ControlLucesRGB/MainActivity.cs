...
namespace ControlLucesRGB
{
    [Activity(Label = "ControlLucesRGB", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : Activity
    {
        ...
        EditText leftValues;
        EditText centralValues;
        EditText rightValues;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            leftValues = FindViewById<EditText>(Resource.Id.txtLeftSeries);
            centralValues = FindViewById<EditText>(Resource.Id.txtCentralSeries);
            rightValues = FindViewById<EditText>(Resource.Id.txtRightSeries);
        ...
        private void ButtonSend_Click(object sender, EventArgs e)
        {
            ...
            finalValue = rightValues.Text + ";" + centralValues.Text + ";" + leftValues.Text + ":";
